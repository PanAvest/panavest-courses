        ...
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-3 flex items-center gap-3">
              ...
              <SocialLink href="https://x.com/PanAvest" label="X">
              ...
              <SocialLink href="https://instagram.com/panavest" label="Instagram">
              ...
              <SocialLink href="https://www.linkedin.com/company/panavest" label="LinkedIn">
              ...
              <SocialLink href="https://facebook.com/panavest" label="Facebook">
