...
/** Server component that fetches top-CPPD programs */
async function ProgramsList() {
  // Highest CPPD first; published only; max 4
  const { data: items, error } = await supabase
    .from("courses")
    .select("id, slug, title, cpd_points, published")
    .eq("published", true)
    .order("cpd_points", { ascending: false })
    .limit(4);

  // Graceful fallback (no redesign)
  if (error || !items || items.length === 0) {
    return (
      <ul className="mt-3 space-y-2 text-sm text-muted">
        <li className="text-muted">No programs yet.</li>
      </ul>
    );
  }
      ...
      <div className="w-full px-4 md:px-6 py-10">
        <div className="grid gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            {/* Dynamic top-CPPD courses */}
            {/** Kept structure: header + <ul> with <li><Link/></li> */}
          ...
          <div>
            ...
            <div className="mt-3 flex items-center gap-3">
              ...
              <SocialLink href="https://www.instagram.com/panavest.inter.partners/?hl=en" label="Instagram">
                <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden><path fill="currentColor" d="M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5Zm10 2H7a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3Zm-5 3.5A5.5 5.5 0 1 1 6.5 13 5.5 5.5 0 0 1 12 7.5Zm0 2A3.5 3.5 0 1 0 15.5 13 3.5 3.5 0 0 0 12 9.5Zm5.75-2.75a1 1 0 1 1-1 1 1 0 0 1 1-1Z"/></svg>
              </SocialLink>
