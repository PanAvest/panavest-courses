  ...
  return (
    <>
      ...
      <section className="relative isolate overflow-hidden bg-[color:var(--color-ink)] py-16 sm:py-20 2xl:py-28">
        {/* decorative background: brand glows + fine dot grid */}
        <div
          aria-hidden
          ...
          style={{
            backgroundImage:
              ...
              "radial-gradient(rgba(245,183,80,0.07) 1px, transparent 1.4px)",
            backgroundSize: "100% 100%, 100% 100%, 24px 24px",
          }}
        />
        {/* faint orbit rings echoing the hero globe, bleeding from the corners */}
        <svg
          aria-hidden
          viewBox="0 0 400 400"
          fill="none"
