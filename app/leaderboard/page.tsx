    ...
    <main className="w-full px-4 md:px-6 py-10">
      <div className="mx-auto max-w-screen-xl">
        ...
        <p className="mt-2 max-w-2xl text-muted">
          Explore professional e-books aligned with our knowledge paths. Signed-in users can purchase and store books in their dashboard.
        </p>
            ...
            books.map((b) => (
              ...
              >
                <div className="bg-white border-b border-light">
                  {b.cover_url ? (
                    // Use next/image for optimization. Ensure the domain is allowed in next.config.js if external.
                    <Image
                      src={b.cover_url}
                      alt={b.title}
                      width={1200}
